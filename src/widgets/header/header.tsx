   ...
   return (
      <header className="header">
         ...
         >
            ...
            <h2 className='navigaion__text'>Dui cras et. Malesuada eget odio. Pellentesque orci.</h2>
            <div className='navigaion__link'>
               <a className='navigaion__link-text'>Link1</a>
               <a className='navigaion__link-text'>Link2</a>
               <a className='navigaion__link-text'>Link3</a>
            </div>
         ...
         <div className='header__ctas' >
            <div className={`navigaion__nav ${isOpened ? 'open' : ''}`}>
               <a className='navigaion__nav-text'>Technology</a>
               <a className='navigaion__nav-text'>Our Mission</a>
               <a className='navigaion__nav-text'>Mint</a>
            </div>

            <div style={{ display: "flex" }}>
               <svg width="108" height="50" viewBox="0 0 128 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path className="header__button"
                     ...
                     stroke="url(#paint0_linear_96_9)" strokeWidth="2" />
                  <defs>
               ...
               >
                  <svg className="svg" width="49" height="50" viewBox="0 0 59 50" fill="none" xmlns="http://www.w3.org/2000/svg" ref={svgRef}>
                     <path
